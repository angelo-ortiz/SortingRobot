...
tout au long de cette premi\`ere partie. 
...
et am\'eliorent grandement la lisibilit\'e du code. 
\begin{itemize}
...
vitesse d'ex\'ecution des diff\'erentes versions de l'algorithme au plus proche:
...
\begin{tikzpicture}[x=0.04cm,y=0.4cm]
  ...
  \node[anchor=mid] at (170,-2.5) {Nombre de couleurs 
	\tikz[baseline]{\draw[yshift=.5ex,->](0,0)--(20,0);}};
  \node[anchor=mid] at (150,17) {Comparaison pour une grille de longueur 300};
